...
(async () => {
  ...
  // NOTE: We intentionally do NOT pre-fill queuedTrackIds here.
  // After a server restart, Spotify's internal queue is lost anyway,
  // so all wished songs must be re-sent. Pre-filling caused songs to
  // never be sent to Spotify after a restart.
